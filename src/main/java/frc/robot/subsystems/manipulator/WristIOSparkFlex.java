...
public class WristIOSparkFlex implements WristIO {
  ...
  public WristIOSparkFlex(int id) {
    ...
    // wristConfig.closedLoop.velocityFF(scaling / 6700.0).p(1.0 /
    // 3000.0).maxOutput(1).minOutput(-1);
    wristConfig.closedLoop.velocityFF(1 / 6700.0).p(1.0 / 3000.0).maxOutput(1).minOutput(-1);
    wristConfig
        .closedLoop
        .smartMotion
        .maxAcceleration(2.0 * 1 / 6700.0)
        .maxVelocity(0.16 * 1 / 6700.0); // TESTME
