...
public class ManipulatorPresetFactory {
  ...
  final LoggedTunableNumber elevatorTrough =
      new LoggedTunableNumber("Elevator Trough", 0); // TODO:DO
  final LoggedTunableNumber wristTrough = new LoggedTunableNumber("Wrist Trough", -.34);
  final LoggedTunableNumber elevatorLevel2 =
      new LoggedTunableNumber("Elevator Level 2", 0); // TODO:DO
  final LoggedTunableNumber wristLevel2 = new LoggedTunableNumber("Wrist Level 2", -.38);
  final LoggedTunableNumber elevatorLevel3 =
      new LoggedTunableNumber("Elevator Level 3", 0); // TODO:DO
